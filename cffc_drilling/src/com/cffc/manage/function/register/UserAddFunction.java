...
public class UserAddFunction implements IFunction {
    private static String defualtPsw = "123456";
    @Override
    public DaoResult doFunction(Map params, Map map1) throws Exception {
        ...
        params.put("login_pass", getDefualtPsw());
    ...
    public static String getDefualtPsw() {
        return defualtPsw;
    }
}
