...
public class DateUtil {
	 ...
	 */
	public static String getAfterDate(String faiureTime,String days){
		DateTimeFormatter dateTimeFormatter = DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss");
		if (faiureTime.equals("")||faiureTime==null){
			return "";
		}
		LocalDate localDateTime = LocalDate.parse(faiureTime, dateTimeFormatter);
