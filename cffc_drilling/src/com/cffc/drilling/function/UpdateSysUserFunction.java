...
public class UpdateSysUserFunction implements IFunction {
    @Override
    public DaoResult doFunction(Map params, Map context) throws Exception {
        ...
        Map user = DataContext.getContext().doHexByIdToMap("hex_cffc_queryUserByLoginCode", "login_code=" + loginCode + "&user_id=" + userId);
        ...
        param.put("funcId", "hex_cffc_updateSysUser");
